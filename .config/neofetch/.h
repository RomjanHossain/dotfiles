...
print_info() {
    ...
    # info cols
    #prin "$(mypad) $(color 1)▂▂ $(color 2)▂▂ $(color 3)▂▂ $(color 4)▂▂ $(color 5)▂▂ $(color 6)▂▂ $(color 7)▂▂ $(color 8)▂▂ $(color 9)▂▂ $(color 10)▂▂"
    #prin ▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂
}
...
#image_source="auto"
# image_source="/home/romjan/.config/neofetch/images/arch.png"
